...
int main() {
    ...
    cout << "[1] Метод послідовних наближень" << endl;
    cout << "[2] Метод Ньютона-Рафсона" << endl;
    cout << endl;
    ...
    try {
        ...
        cout << "Кількість кроків: " << computation_result.iteration_count << endl;
        cout << "Перевірка: f(" << computation_result.solution_value << ") = "
